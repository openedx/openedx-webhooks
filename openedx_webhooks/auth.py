...
class BaseUrlSession(requests.Session):
    ...
    def request(self, method, url, data=None, headers=None, **kwargs):  # type: ignore[override]
        return super().request(method=method, url=self.base_url.relative(url), data=data, headers=headers, **kwargs)
